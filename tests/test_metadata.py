"""Regression tests for package metadata consistency."""
...
import mcp_facture_electronique_fr
...
def test_version_slot_consistency() -> None:
    ...
    assert mcp_facture_electronique_fr.__version__ == pyproject["project"]["version"], (
        f"__version__={mcp_facture_electronique_fr.__version__} drifted from "
